    ...
    return (
      ...
      >
        ...
        <Link href="/" className="absolute top-2 sm:top-4 md:top-6 left-2 sm:left-4 md:left-6 z-10 no-underline">
          <button
            className="bg-transparent border-2 border-[#a30c29] rounded-lg text-[#a30c29] font-bold text-xs sm:text-sm md:text-lg px-2 sm:px-3 md:px-6 py-1 sm:py-2 md:py-3 cursor-pointer transition-all duration-200 outline-none"
            style={{
              fontFamily: "Orbitron",
            }}
            onMouseEnter={e => {
        ...
        <div
          className="bg-[rgba(40,8,20,0.97)] border-2 border-[#a30c29] rounded-2xl min-w-[280px] sm:min-w-[320px] md:min-w-[410px] max-w-[530px] w-[90vw] min-h-[140px] sm:min-h-[160px] mx-auto flex flex-col justify-center items-center shadow-lg p-3 sm:p-4 md:p-6 lg:p-8"
          style={{
            boxShadow: "0 2px 24px #b0273a35",
          }}
        >
          <h2
            className="text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl font-extrabold text-[#b0273a] mb-3 sm:mb-4 md:mb-6 text-center tracking-[2px] mt-0"
            style={{
              fontFamily: "Orbitron",
          ...
          <div className="flex flex-col gap-2 sm:gap-3 md:gap-4 w-full max-w-sm sm:max-w-md">
            <button
              className="w-full font-bold text-xs sm:text-sm md:text-base lg:text-lg uppercase py-2 sm:py-3 tracking-[1.9px] cursor-pointer transition-all duration-200 outline-none rounded-xl"
              style={{
            ...
            <button
              className="w-full font-bold text-xs sm:text-sm md:text-base lg:text-lg uppercase py-2 sm:py-3 tracking-[1.9px] cursor-pointer transition-all duration-200 outline-none rounded-xl mb-1"
              style={{
